        ...
        <section className="property-categories-section flex flex-col items-center justify-center">
            ...
            <div className="property-grid-container flex flex-col gap-[44px]">
                ...
                <div className="flex flex-row gap-[44px]">
                    {/* Commercial Offices */}
                    <div className="property-frame-commercial flex flex-col">
                        <div className="w-[754px] h-[285.93px] overflow-hidden">
                            <HotelImage className="w-full h-full object-cover" />
                        </div>
                        <div className="property-outer-box-commercial flex items-center">
                            <span className="text-property-category">Commercial Offices</span>
                        </div>
                    </div>

                    {/* Premium Residential */}
                    <div className="property-frame-premium flex flex-col">
                        <div className="w-[477px] h-[285.93px] overflow-hidden">
                            <FlatBuildingImage className="w-full h-full object-cover" />
                        </div>
                        <div className="property-outer-box-premium flex items-center">
                ...
                <div className="flex flex-row gap-[44px]">
                    {/* Retail & Mixed-Use */}
                    <div className="property-frame-retail flex flex-col">
                        <div className="w-[477px] h-[267px] overflow-hidden">
                            <RetailImage className="w-full h-full object-cover" />
                        </div>
                        <div className="property-outer-box-retail flex items-center">
                            <span className="text-property-category">Retail & Mixed-Use</span>
                        </div>
                    </div>

                    {/* Industrial & Logistics */}
                    <div className="property-frame-industrial flex flex-col">
                        <div className="w-[477px] h-[268px] overflow-hidden">
                            <IndustryImage className="w-full h-full object-cover" />
                        </div>
                        <div className="property-outer-box-industrial flex items-center">
                            <span className="text-property-category">Industrial & Logistics</span>
                        </div>
                    </div>

                    {/* Luxury Properties */}
                    <div className="property-frame-luxury flex flex-col">
                        <div className="w-[266px] h-[268px] overflow-hidden">
                            <FarmHouseImage className="w-full h-full object-cover" />
                        </div>
                        <div className="property-outer-box-luxury flex items-center">
