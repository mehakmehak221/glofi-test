    ...
    const sections: {
        ...
        anchorId?: string;
    }[] = [
            {
                ...
                content: "At GloFi Estates, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our services."
            },
            {
                ...
                <div className="container-main relative z-10">
                    ...
                    >
                        ...
                        <div className="text-body text-lg text-neutral-600 space-y-2">
                            ...
                            <p>This privacy policy applies to all GloFi Estates products and services.</p>
                        </div>
                    </motion.div>
                </div>
            </section>
