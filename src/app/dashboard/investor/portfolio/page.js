            ...
            >
                {STATS.map((stat, idx) => (
                    ...
                    >
                        ...
                        <p className="text-3xl font-bold text-[var(--header-text)] mb-2">{stat.value}</p>
                        {stat.change && (
                ...
                <div className="flex-1 w-full flex flex-col justify-center">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <motion.button
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 rounded-lg bg-[var(--background)] text-[var(--color-text-muted)] text-[11px] font-bold hover:text-[var(--header-text)] transition-all border border-[var(--sidebar-border)] cursor-pointer"
                        >
