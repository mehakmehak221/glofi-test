                ...
                >
                    ...
                    {activeTab === "KYC" && (
                        <div className="bg-[var(--sidebar-bg)] border border-[var(--sidebar-border)] rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 max-w-[800px] shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
                                <div className="bg-[var(--background)] border border-[var(--sidebar-border)] rounded-lg sm:rounded-xl p-3.5 sm:p-5 flex items-start gap-2.5 sm:gap-3.5 hover:border-[var(--sidebar-active-text)]/20 transition-colors">
                    ...
                    {activeTab === "Wallet" && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-5 xl:max-w-[70rem]">
                            <div
                                className="rounded-[16px] sm:rounded-[24px] p-4 sm:p-7 relative overflow-hidden shadow-[var(--shadow-glow-primary)]"
