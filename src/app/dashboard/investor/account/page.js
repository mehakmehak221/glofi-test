...
export default function AccountPage() {
    ...
    return (
        <div className="p-3 sm:p-6 lg:p-8 bg-[var(--color-bg-dark)] min-h-screen">
                ...
                {TABS.map((tab) => (
                    <button
                        ...
                        className={`px-3.5 sm:px-5 py-2 sm:py-2.5 rounded-full text-[11px] sm:text-[13px] font-medium transition-all duration-300 cursor-pointer border ${activeTab === tab
                            ...
                            : "bg-[var(--color-bg-surface-subtle)] text-[var(--color-text-muted)] border-[var(--color-border-subtle)] hover:border-[var(--color-border-muted)] hover:text-white"
                            }`}
                    >
                        {tab}
                    </button>
                ...
                >
                    ...
                    {activeTab === "KYC" && (
                        <div className="bg-[var(--color-bg-dark-alt)] border border-[var(--color-border-subtle)] rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 max-w-[800px]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
                                <div className="bg-[var(--color-bg-surface-subtle)] border border-[var(--color-border-subtle)] rounded-lg sm:rounded-xl p-3.5 sm:p-5 flex items-start gap-2.5 sm:gap-3.5 hover:border-[var(--color-primary-300)]/20 transition-colors">
                    ...
                    {activeTab === "Wallet" && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-5 xl:max-w-[70rem]">
                            <div className="rounded-[16px] sm:rounded-[24px] p-4 sm:p-7 relative overflow-hidden shadow-[var(--shadow-glow-primary)] bg-[var(--color-gradient-glofi)]">
                                <div className="absolute right-0 top-0 w-40 h-40 bg-[var(--color-bg-surface-subtle)] rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none"></div>
                                ...
                                <div className="flex gap-2">
                                    <button className="px-3 py-1 bg-black/10 text-black text-[10px] sm:text-[11px] font-normal tracking-wide rounded-full transition-colors cursor-pointer border border-black/5">Deposit</button>
                                    <button className="px-3 py-1 bg-black/10 text-black text-[10px] sm:text-[11px] font-normal tracking-wide rounded-full border border-black/5 transition-colors cursor-pointer">Withdraw</button>
                                </div>
                            </div>

                            <div className="rounded-[16px] sm:rounded-[24px] p-4 sm:p-7 relative overflow-hidden bg-gradient-to-b from-[var(--color-bg-dark-alt)] to-[var(--color-primary-700)] shadow-[var(--shadow-glow-primary)]">
                                <div className="absolute right-0 top-0 w-40 h-40 bg-[var(--color-bg-surface-subtle)] rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none"></div>
                            ...
                            <div className="rounded-[16px] sm:rounded-[24px] p-4 sm:p-7 relative overflow-hidden bg-gradient-to-b from-[var(--color-bg-dark-alt)] to-[var(--color-primary-300)] shadow-[var(--shadow-glow-primary)]">
                                <div className="absolute right-0 top-0 w-40 h-40 bg-[var(--color-bg-surface-subtle)] rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none"></div>
                    ...
                    {activeTab === "Certificates" && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 xl:max-w-6xl">
                            ...
                            {[
                                ...
                                <div key={i} className="bg-[var(--color-bg-dark-alt)] border border-[var(--color-primary-300)]/10 rounded-xl sm:rounded-[20px] p-3.5 sm:p-5 lg:p-6 hover:border-[var(--color-primary-300)]/20 transition-colors">
                                    ...
                                    <div className="border border-[var(--color-border-subtle)] rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-3 sm:mb-5">
                                        <div className="text-center">
                                            ...
                                            <p className="font-bold text-white flex items-center justify-center gap-1.5 sm:gap-2"><span className="text-2xl sm:text-3xl">{cert.fractions}</span> <span className="text-[11px] sm:text-[13px] font-normal text-[var(--color-text-muted)]">Fractions</span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                                        ...
                                        <div className="flex justify-between items-center text-[11px] sm:text-[13px]">
                                            ...
                                            <span className="text-white font-mono flex items-center gap-1.5 sm:gap-2">
                                                Qm...x4Kp
                                                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[var(--color-text-muted)] cursor-pointer hover:text-white transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-2 sm:gap-3 w-full">
                                        ...
                                        <button className="flex-1 px-3 sm:px-4 py-2 sm:py-3 bg-transparent hover:bg-[var(--color-bg-surface-subtle)] text-[var(--color-text-muted)] hover:text-[var(--color-text-secondary)] text-[10px] sm:text-[11px] font-bold tracking-widest uppercase rounded-full flex justify-center items-center gap-1.5 sm:gap-2 border border-[var(--color-border-muted)] transition-colors cursor-pointer">
                    ...
                    {activeTab === "Referrals" && (
                        <div className="bg-[var(--color-bg-dark-alt)] border border-[var(--color-border-subtle)] rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-10 max-w-[900px]">
                            ...
                            <div className="flex items-center bg-[var(--color-bg-surface-subtle)] border border-[var(--color-border-subtle)] rounded-full p-1 sm:p-1.5 mb-6 sm:mb-10 w-full max-w-[800px]">
                                <input
                                    readOnly
                                ...
                                <button
                                    onClick={handleCopy}
                                    className={`px-4 sm:px-6 lg:px-8 py-2 sm:py-2.5 rounded-full text-[10px] sm:text-xs font-bold tracking-wide hover:scale-105 transition-all flex items-center gap-1.5 sm:gap-2 shadow-[var(--shadow-glow-primary)] cursor-pointer border-0 ${copied ? 'bg-[var(--color-primary-700)] text-white' : 'bg-[var(--color-primary-300)] text-black'}`}
                                >
                                    {copied ? (
                                        <>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-5 lg:gap-6">
                                ...
                                <div className="bg-[var(--color-bg-surface-subtle)] border border-[var(--color-border-subtle)] rounded-xl sm:rounded-[16px] p-4 sm:p-6 relative overflow-hidden group hover:border-[var(--color-primary-300)]/20 transition-colors cursor-default">
                                    <div className="absolute right-4 sm:right-5 top-4 sm:top-5 text-[var(--color-primary-300)] w-7 h-7 sm:w-9 sm:h-9 flex items-center justify-center bg-[var(--color-primary-300)]/10 rounded-full group-hover:scale-110 transition-transform">
                                    ...
                                    <p className="text-[9px] sm:text-[10px] uppercase font-bold text-white/30 mb-2 sm:mb-4 tracking-[1.5px]">REFERRALS</p>
                                ...
                                <div className="bg-[var(--color-bg-surface-subtle)] border border-[var(--color-border-subtle)] rounded-xl sm:rounded-[16px] p-4 sm:p-6 relative overflow-hidden group hover:border-[var(--color-primary-300)]/20 transition-colors cursor-default">
                                    ...
                                    <p className="text-[9px] sm:text-[10px] uppercase font-bold text-white/30 mb-2 sm:mb-4 tracking-[1.5px]">CONVERTED</p>
                                ...
                                <div className="bg-[var(--color-bg-surface-subtle)] border border-[var(--color-border-subtle)] rounded-xl sm:rounded-[16px] p-4 sm:p-6 relative overflow-hidden group hover:border-[var(--color-primary-300)]/20 transition-colors cursor-default">
                                    ...
                                    <p className="text-[9px] sm:text-[10px] uppercase font-bold text-white/30 mb-2 sm:mb-4 tracking-[1.5px]">EARNED</p>
