...
const DOCUMENTS = [
    {
        name: "Title Deed", icon: <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M11.6663 7.58343C11.6663 10.5001 9.62467 11.9584 7.19801 12.8043C7.07094 12.8473 6.9329 12.8453 6.80717 12.7984C4.37467 11.9584 2.33301 10.5001 2.33301 7.58343V3.5001C2.33301 3.34539 2.39447 3.19702 2.50386 3.08762C2.61326 2.97822 2.76163 2.91677 2.91634 2.91677C4.08301 2.91677 5.54134 2.21677 6.55634 1.3301C6.67992 1.22452 6.83713 1.1665 6.99967 1.1665C7.16222 1.1665 7.31943 1.22452 7.44301 1.3301C8.46384 2.2226 9.91634 2.91677 11.083 2.91677C11.2377 2.91677 11.3861 2.97822 11.4955 3.08762C11.6049 3.19702 11.6663 3.34539 11.6663 3.5001V7.58343Z" stroke="#ACFFEF" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    },
    {
...
export default function PropertyDetailPage() {
    ...
    if (!property) {
        return (
            <div className="p-4 sm:p-6 lg:p-8 bg-[#0A0F0D] min-h-screen flex items-center justify-center">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                >
                    ...
                    <div className="relative w-full h-56 sm:h-72 lg:h-80 rounded-2xl overflow-hidden mb-5">
                        ...
                        <span className="absolute top-3 left-3 sm:top-4 sm:left-4 px-2.5 py-1 rounded-md text-[10px] font-semibold uppercase tracking-wider bg-[#0a0a0a]/80 text-[#a0a0a0] border border-white/10 backdrop-blur-sm">
                            {property.category}
                        </span>
                    ...
                    <p className="text-sm rounded-xl p-3 sm:p-4 text-[#FFFFFF59] leading-relaxed mb-6" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                        ...
                        >
                            <p className="text-[10px] uppercase tracking-wider text-gray-500 mb-1">Valuation</p>
                        ...
                        <div
                            ...
                            style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}
                        >
                            <p className="text-[10px] uppercase tracking-wider text-gray-500 mb-1">Yield</p>
                            <p className="text-base sm:text-lg font-bold text-[#00FFCD]">{property.yield}</p>
                        </div>
                        <div
                            className="rounded-xl p-3 sm:p-4"
                            style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}
                        >
                            <p className="text-[10px] uppercase tracking-wider text-gray-500 mb-1">Risk Level</p>
                        ...
                        <div
                            ...
                            style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}
                        >
                            <p className="text-[10px] uppercase tracking-wider text-gray-500 mb-1">Fractions</p>
                    ...
                    <div>
                        <h3 className="text-sm font-semibold text-[#FFFFFF99] mb-3">Documents</h3>
                            ...
                            {DOCUMENTS.map((doc) => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <span className="w-7 h-7 rounded-full bg-[#00FFCD]/10 flex items-center justify-center text-xs">
                                            {doc.icon}
                                        </span>
                                        <span className="text-sm text-[#FFFFFF99]">{doc.name}</span>
                                    </div>
                                    <button className="flex items-center gap-1.5 text-xs text-[#00FFCD] bg-transparent border-0 cursor-pointer hover:underline">
                ...
                >
                    <div
                        className="rounded-2xl p-5 sm:p-6 lg:sticky lg:top-24"
                        style={{
                            background: 'linear-gradient(180deg, #0D1411 0%, #0A0F0D 100%)',
                            border: '1px solid rgba(0, 218, 175, 0.10)',
                        }}
                    >
                        <p className="text-[10px] uppercase tracking-[2px] text-[#767676] mb-1">Per Fraction</p>
                        ...
                        <div className="space-y-3 mb-6">
                            <div className="flex items-center justify-between py-2 border-b border-white/[0.06]">
                                <span className="text-xs text-[#767676]">Available</span>
                                <span className="text-sm text-[#FFFFFF99] font-medium">{property.available}</span>
                            </div>
                            <div className="flex items-center justify-between py-2 border-b border-white/[0.06]">
                                <span className="text-xs text-[#767676]">Yield</span>
                                <span className="text-sm text-[#00FFCD] font-medium">{property.yield} p.a.</span>
                            </div>
                            <div className="flex items-center justify-between py-2">
                                <span className="text-xs text-[#767676]">Broker</span>
                                <span className="text-sm text-[#FFFFFF99] font-medium">{property.broker}</span>
                            </div>
                        </div>
