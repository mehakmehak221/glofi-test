                                                    ...
                                                    <div className="flex-1 w-full flex flex-col gap-4 sm:gap-2">
                                                        <div className="flex flex-row items-center justify-between sm:justify-start gap-4">
                                                            ...
                                                            {item.status && (
                                                                <div className={`px-2.5 py-1 rounded-md text-[9px] font-bold uppercase tracking-wider border ${
                                                                    item.status === "PENDING" ? "bg-[var(--color-status-warning-bg)] text-[var(--color-status-warning)] border-[var(--color-status-warning-border)]" :
                                                                    item.status === "APPROVED" ? "bg-[var(--color-status-success-bg)] text-[var(--color-status-success)] border-[var(--color-status-success-border)]" :
                                                        ...
                                                        <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-4 sm:gap-6 lg:gap-8 w-full mt-2">
                                                            <div>
                                                                ...
                                                                <p className="text-xs sm:text-sm font-bold text-[var(--header-text)]">{item.fractions}</p>
                                                            </div>
                                                            <div>
                                                                <p className="text-[10px] uppercase tracking-wider text-[var(--color-text-muted)] mb-1 font-bold">Price Per Fraction</p>
                                                                <p className="text-xs sm:text-sm font-bold text-[var(--header-text)]">${item.pricePerFraction?.toLocaleString()}</p>
                                                            </div>
                                                            <div>
                                                                <p className="text-[10px] uppercase tracking-wider text-[var(--color-text-muted)] mb-1 font-bold">Total Value</p>
                                                                <p className="text-xs sm:text-sm font-bold text-[var(--sidebar-active-text)]">${(item.fractions * item.pricePerFraction || 0).toLocaleString()}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
