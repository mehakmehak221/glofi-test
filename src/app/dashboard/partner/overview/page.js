...
function StatCard({ label, value, delta, icon: Icon, index }) {
    return (
        <motion.div
            ...
            className="bg-[var(--sidebar-bg)] border border-[var(--sidebar-border)] rounded-md p-5 flex flex-col gap-3 hover:shadow-md transition-all"
        >
    ...
    return (
        <div className="p-6 lg:p-8 max-w-[1200px] mx-auto">
            ...
            <motion.div
                ...
                className="bg-[var(--sidebar-bg)] border border-[var(--sidebar-border)] rounded-md p-5"
            >
                <div className="flex items-center justify-between mb-6">
