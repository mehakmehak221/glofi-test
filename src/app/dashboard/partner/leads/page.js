...
const StatCard = ({ label, value, delta, icon: Icon, color, bgColor }) => (
    <div className="flex-1 min-w-[180px] bg-[var(--sidebar-bg)] border border-[var(--sidebar-border)] rounded-xl p-5 hover:shadow-md transition-all group relative overflow-hidden">
        {Icon && (
...
const AutomationCard = ({ item }) => (
    <div className="bg-[var(--sidebar-bg)] border border-[var(--sidebar-border)] rounded-2xl p-6 hover:shadow-md transition-all group">
            ...
            <AnimatePresence mode="wait">
                ...
                {activeTab === "Automation" && (
                    ...
                    >
                        ...
                        <div className="bg-[var(--sidebar-bg)] border border-dashed border-[var(--sidebar-border)] rounded-2xl p-6 flex flex-col items-center justify-center gap-3 hover:border-[var(--sidebar-active-text)]/30 hover:bg-[var(--sidebar-active-bg)]/50 transition-all cursor-pointer group min-h-[280px]">
