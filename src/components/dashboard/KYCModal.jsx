            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-xs text-[var(--color-text-secondary)] mb-5">Upload a government-issued ID to verify your identity.</p>
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-[var(--color-primary-300-alpha-10)] flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-[var(--color-text-secondary)]">Clear photo of front side</p>
                                    </div>
                                </div>
                                {docUploaded ? (
                                    <span className="text-xs font-semibold text-[var(--color-primary-300)] bg-[var(--color-primary-300-alpha-10)] px-2.5 py-1 rounded-md">DONE</span>
                                ) : (
                                    <button
                                        onClick={() => setDocUploaded(true)}
                                        className="text-xs text-[var(--color-primary-300)] bg-transparent border border-[var(--color-primary-300-alpha-30)] px-3 py-1 rounded-md cursor-pointer hover:bg-[var(--color-primary-300-alpha-10)] transition-colors"
                                    >
                                        Upload
                                    </button>
                                )}
                            ...
                            {docUploaded && (
                                <p className="text-[10px] text-[var(--color-text-secondary)] mt-2 ml-11">PX_IMG_001 — Uploaded 2024</p>
                            )}
                        </div>
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-[var(--color-bg-surface-subtle)] flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-[var(--color-text-secondary)]">A live photo — hold next to your face</p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => setSelfieUploaded(true)}
                                    className={`text-xs px-3 py-1 rounded-md cursor-pointer transition-colors ${selfieUploaded
                                        ? "text-[var(--color-primary-300)] font-semibold bg-[var(--color-primary-300-alpha-10)] border-0"
                                        : "text-[var(--color-primary-300)] bg-transparent border border-[var(--color-primary-300-alpha-30)] hover:bg-[var(--color-primary-300-alpha-10)]"
                                        }`}
                                >
                        ...
                        <div className="flex items-center gap-2 mb-5 p-2 rounded-lg" style={{ background: 'var(--color-bg-surface-subtle)', border: '1px solid var(--color-border-subtle)' }}>
