        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    <motion.div
                        className="relative w-full max-w-sm rounded-2xl p-5 sm:p-6 bg-[var(--color-bg-dark-alt)] border border-[var(--color-primary-300-alpha-30)]"
                    ...
                    >
                        ...
                        {isKYC && (
                            <div className="flex items-center justify-between mb-6">
                                <div className="flex items-center gap-1.5 text-[10px] uppercase tracking-[2px] text-[var(--color-text-muted)] font-medium">
                                    <SmallShieldIcon />
                        ...
                        <div className="flex justify-center mb-5 mt-2">
                            {isKYC ? (
                                <motion.div
                                    className="w-16 h-16 rounded-full flex items-center justify-center bg-[var(--color-primary-300-alpha-10)] shadow-[0_0_40px_0_var(--color-primary-300-alpha-30)]"
                                    initial={{ scale: 0 }}
                                    animate={{ scale: 1 }}
                                ...
                                <motion.div
                                    className="w-16 h-16 rounded-2xl flex items-center justify-center bg-[var(--color-primary-300-alpha-10)] border border-[var(--color-primary-300-alpha-30)]"
                                    initial={{ scale: 0 }}
                                    animate={{ scale: 1 }}
                                    transition={{ delay: 0.2, type: "spring", stiffness: 300 }}
                                >
                                    <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="var(--color-primary-300)" strokeWidth={2.5}>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-xs sm:text-sm text-[var(--color-text-secondary)] mb-5 leading-relaxed">
                                {isKYC
                            ...
                            {isKYC && (
                                <div className="flex justify-center mb-5">
                                    <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs text-[var(--color-text-muted)] border border-[var(--color-border-subtle)] bg-[var(--color-bg-surface-subtle)]"
                                    >
                        ...
                        <div className={`${isKYC ? "" : "flex justify-center"}`}>
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                onClick={onClose}
                                className={`py-3.5 bg-[var(--color-gradient-glofi)] text-black font-semibold text-sm cursor-pointer border-0 transition-shadow hover:shadow-[0_0_20px_var(--color-primary-300-alpha-30)] ${isKYC ? "w-full rounded-xl" : "px-12 rounded-full"
                                    }`}
                            >
