                    ...
                    >
                        ...
                        <div className={`${isKYC ? "" : "flex justify-center"}`}>
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                onClick={onClose}
                                className={`py-4 rounded-md bg-[var(--color-primary-300)] text-[var(--background)] font-bold text-sm cursor-pointer border-0 transition-all hover:opacity-90 shadow-glow-primary ${isKYC ? "w-full" : "px-14"
                                    }`}
                            >
