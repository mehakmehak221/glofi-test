    ...
    return (
        <footer id="support" className="site-footer">
            <div className="site-footer__inner">
                ...
                <div className="site-footer__app-buttons">
                    <Link
                ...
                <nav className="site-footer__nav" aria-label="Footer navigation">
                    {NAV_LINKS.map((link) => (
                        <Link key={link.label} href={link.href} className="site-footer__nav-link">
                            {link.label}
                        </Link>
                    ))}
                </nav>
                ...
                <p className="site-footer__copyright">Copyright © 2026 GloFi Real Estates</p>
            </div>
        </footer>
    );
}
