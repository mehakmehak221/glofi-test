    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    <motion.div
                        className="cookie-section-wrapper w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-3 sm:py-4 lg:py-5 bg-[var(--color-bg-dark)] border-t border-[var(--color-primary-300-alpha-30)] backdrop-blur-lg flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 lg:gap-6 text-center sm:text-left"
                        initial={{ scale: 0.96 }}
                        animate={{ scale: 1 }}
